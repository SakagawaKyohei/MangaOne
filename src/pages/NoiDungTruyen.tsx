      ...
      <div style={{ height: "40vh" }}>
        ...
        >
          ...
          >
            ...
            >
              <img src={mangaimage} style={{ height: 300, paddingRight: 18 }} />
              <div>
                <h1 style={{ color: "white", paddingBottom: 5 }}>TÊN TRUYỆN</h1>
                <p style={{ color: "white", fontSize: 18, paddingBottom: 58 }}>
                  Tên khác
                </p>
                <p style={{ color: "white", fontSize: 18, paddingBottom: 55 }}>
                  Tên tác giả
                </p>
                <Button
                  style={{
